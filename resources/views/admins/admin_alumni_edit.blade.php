                        ...
                        <form action="{{ url('admin-update-alumni', $edt->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="pengalaman" rows="30" id="editor" class="form-control" placeholder="Masukkan Pengalaman" value="" required oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')">{{ $edt -> pengalaman }}</textarea>
                                </div>
