        ...
        <div class="row">
            <div class="wow fadeInUp col-md-12 col-sm-12" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
                <div class="section-title">
                    <h3 style="color: #ffffff;">Artikel LBB Study Extra</h3>
                    <p style="color: #ffffff;">Sempatkan diri untuk menambah literasi dengan membaca kumpulan informasi dari LBB Study Extra</p>
                </div>
            </div>
